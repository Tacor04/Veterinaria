...
namespace CapaPresentacion
{
    public partial class FrmProducto : Form
    {
        ...
        private void FrmProducto_Load(object sender, EventArgs e)
        {
            ...
            List<Producto> lista = new CD_Producto().Listar();
        ...
        private void Btnguardar_Click(object sender, EventArgs e)
        {
            Producto obj = new Producto()
            {
                ...
                Categoria = new Categoria() { IdCategoria = Convert.ToInt32(((OpcionCombo)cbocategoria.SelectedItem).Valor) },
        ...
        private void Btnexportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    FileName = string.Format("ReporteProducto_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss")),
